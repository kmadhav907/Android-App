...
import com.example.messenger.databinding.ItemReceiveGroupBinding;
import com.example.messenger.databinding.ItemReciveBinding;

import com.example.messenger.databinding.ItemSentBinding;
import com.example.messenger.databinding.ItemSentGroupBinding;
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if(holder.getClass() == SentViewHolder.class){
            ...
            if(message.getMessage().equals("photo")){
                ...
                Glide.with(context).load(message.getImageUrl()).placeholder(R.drawable.image_placeholder).into(viewHolder.binding.image);
            }
            FirebaseDatabase.getInstance().getReference()
                    .child("users")
                    ...
                    .addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                            if(snapshot.exists()){
                                ...
                                viewHolder.binding.gsusername.setText("@"+user.getName());
                            }
                        }
            ...
            FirebaseDatabase.getInstance().getReference()
                    ...
                    .addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                            if(snapshot.exists()){
                                User user = snapshot.getValue(User.class);
                                viewHolder.binding.grusername.setText("@"+user.getName());
                            }
                        }
